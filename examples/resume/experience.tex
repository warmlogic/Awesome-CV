  ...
  \cventry
    ...
    {Mar. 2017 -- Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Data analysis, predictive model building and assessment, and processing pipeline to provide the analytics backend for data collected via a mobile application.}
     \end{cvitems}
    }
